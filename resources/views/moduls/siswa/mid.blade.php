        ...
        <div class="card bg-primary">
            ...
            <div class="card-body">
                ...
                <h5 class="card-title">Nama Paket 
                    <input type="text" id="staticnama_paket" readonly class="form-control-plaintext" name="nama_paket" value="Mid">
                </input></h5>
                </div>
                    <div class="col-sm-3">
                ...
                @endforeach
                <div class="col-sm-3">
                <input type="text" id="staticestimasi" style="visibility:hidden;" name="estimasi" value="3 Bulan">
                </input>
                </div>
                <div class="col-sm-3">
                <input type="text" id="staticjumlah" style="visibility:hidden;" name="jumlah_pertemuan" value="12">
                </input>
                </div>
                <div class="col-sm-3">
                <input type="text" id="staticharga" style="visibility:hidden;" name="harga" value="40000">
                </input>
                </div>
                <div class="col-sm-3">
                <input type="text" id="staticstatus" style="visibility:hidden;" name="status" value="billing">
                </input>
                </div>
                <div class="col-sm-3">
