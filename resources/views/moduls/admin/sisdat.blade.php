    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Menampilkan Data siswa</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="cetaksisdat"><i class="fa fa-print fa-lg" title="Cetak Data"></i></a></li>
          <li class="breadcrumb-item active"><a href="#">Table Data Siswa</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
