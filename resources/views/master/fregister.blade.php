            ...
            <form method="POST" action="{{ route('register') }}">
                        @csrf
                         <div class="form-group">
								<input style="visibility: hidden;" type="text" id="sebagai" class="form-control" value="Tutor" name="sebagai"></input>
                ...
                <div class="form-group">
									<input style="visibility: hidden;" type="text" id="status" class="form-control" value="3" name="is_Admin"></input>
								</div>
                <div class="form-group row">
